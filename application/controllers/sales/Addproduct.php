...
class Addproduct extends Sales_Controller
{
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            if (!empty($_FILES['gambar']['name'])) {
                ...
                if ($this->gambar->do_upload('gambar')) {
                    ...
                    redirect('sales/addproduct', 'refresh');
                }
            }
            ...
            $this->load->view('sales/product/addproduct', $this->data);
        }
    }
    public function manageProduct()
    {
        ...
        $this->load->view('sales/product/manageProduct', $this->data);
    }
    ...
    public function produkTerjual()
    {
        ...
        $this->load->view('sales/product/produkterjual', $this->data);
    }
}
