        ...
        <div class="row">
            <div class="col-md-4">
                <form action="" method="POST">
                    <?php if (!empty($edit_sales)) : ?>
                        <fieldset class="form-fieldset">
                            <div class="mb-3">
                                <label class="form-label required">Nama Depan</label>
                                <input type="text" class="form-control" value="<?= $edit_sales['nama_depan'] ?>" name="nama_depan" autocomplete="off" />
                            </div>
                            <div class="mb-3">
                                <label class="form-label required">Nama Belakang</label>
                                <input type="text" class="form-control" value="<?= $edit_sales['nama_belakang'] ?>" name="nama_belakang" autocomplete="off" />
                            </div>
                            <div class="mb-3">
                                <label class="form-label required">No. HP</label>
                                <input type="tel" class="form-control" value="<?= $edit_sales['hp'] ?>" name="hp" autocomplete="off" />
                            </div>
                            <button type="submit" name="edit_sales" value="1" class="btn btn-primary">Tambah Sales</button>
                        </fieldset>
                    ...
                    <?php else : ?>
                        <fieldset class="form-fieldset">
                            ...
                            <div class="mb-3">
                                <label class="form-label required">No. HP</label>
                                <input type="tel" class="form-control" name="hp" autocomplete="off" />
                            </div>
                            <button type="submit" name="tambah_sales" value="1" class="btn btn-primary">Tambah Sales</button>
                        </fieldset>
                                            ...
                                            <td class="text-right">
                                                <span class="dropdown ml-1">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="<?= base_url('admin/pengaturan/managesales/') . $d['id_sales'] ?>">
                                                            Edit
                                                        </a>
                                                        <a class="dropdown-item hapus" href="<?= base_url('admin/pengaturan/hapussales/') . $d['id_sales'] ?>">
                                                            Hapus
                                                        </a>
                                                    </div>
                                                </span>
